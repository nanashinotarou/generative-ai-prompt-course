...
<body>
    ...
    <div class="container">
        ...
        <div class="hero">
            ...
            <h1>Canvaの基本操作</h1>
            <p>本日の目標：デザインツールとしてのCanvaの活用法を学び、AI機能を使った効果的なコンテンツ制作を行う。<br>プロンプトを中心に作成した動画作品を3本以上作成し、任意のSNSで公開するための第一歩です。</p>
        </div>
        ...
        <div class="tab-nav">
            ...
            <button class="tab-btn" onclick="switchTab('tab-first')"><i class="fa-solid fa-sun" style="color:#3b82f6;"></i> 前半：Canva実習</button>
            <button class="tab-btn" onclick="switchTab('tab-second')"><i class="fa-solid fa-moon" style="color:#8b5cf6;"></i> 後半：プロンプトノート</button>
        ...
        <div id="tab-goal" class="tab-content active">
            <div class="glass-card" style="border-top: 5px solid #f59e0b;">
                ...
                <div class="info-box" style="border-left-color: #f59e0b; background: #fffbeb;">
                    <h4 style="color:#b45309;"><i class="fa-solid fa-palette"></i> デザインを民主化するAIツールの活用</h4>
                    <p style="color:#92400e;">
                        本日は「Canva」を通じて、デザインのハードルを極限まで下げる体験をします。<br><br>
                        AIを組み合わせることで、「プロンプトで生成した素材」を瞬時に「高品質なクリエイティブ（動画やサムネイル等）」へ昇華できるようになります。デザインスキルの壁を越えて、世界中の人へあなたのアイデアを届けられる人材を目指しましょう！
                    </p>
                </div>
            </div>
        ...
        <div id="tab-first" class="tab-content">
            <div class="glass-card" style="border-top: 5px solid #3b82f6;">
                ...
                <p style="font-size:1.1rem; margin-bottom:1.5rem;">Canvaの基本的な使い方、そして強力なAI機能（マジック生成など）についての解説を視聴します。</p>
            ...
            <div class="glass-card">
                <div class="card-header"><i class="fa-solid fa-laptop-code" style="color:#10b981; background:#f0fdf4;"></i><h2>前半：実習（Canvaの使い方を覚えよう）</h2></div>
                <p style="font-size:1.1rem;">実際にCanvaにログインし、投稿の作成からAI機能を試すところまで実践します。</p>
                
                <div class="info-box">
                    <h4><i class="fa-solid fa-star"></i> おすすめの使い方 3ステップ</h4>
                    <p>①テンプレートを選ぶ → ②テキスト・色を変える → ③AI機能（マジック生成やマジック消しゴム）で画像を加工する！</p>
                </div>
                ...
                <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 2rem;">
                    <div class="box canva">
                        ...
                        <ul style="padding-left:20px; line-height:2.2;">
                            <li>「デザインを作成」からサイズを選択</li>
                            <li>Ctrl+C / Ctrl+V でコピペ</li>
                            <li>Ctrl+D で要素の複製</li>
                            <li>重なり順の調整（前面・背面）</li>
                        </ul>
                    </div>
                    <div class="box canva">
                        <h4>マジックスタジオ（AI機能）</h4>
                        <ul style="padding-left:20px; line-height:2.2;">
                            <li>マジック生成（テキスト→画像）</li>
                            <li>マジック消しゴム・背景リムーバ</li>
                            <li>マジック拡張（AIで描きたし）</li>
                            <li>Dream Lab（超高品質なAIスタジオ）</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="mission-area" id="mission-group-1">
                    <div class="wax-seal" style="background: radial-gradient(circle at 30% 30%, #60a5fa, #3b82f6, #1d4ed8); border-color:#1e3a8a;"><i class="fa-solid fa-check"></i></div>
                    <div class="mission-header">
                        <h3><i class="fa-solid fa-clipboard-list"></i> MILESTONE 1: Canvaデビュー</h3>
                    ...
                    <ul class="task-list">
                        <li class="task-item" onclick="toggleTask('t1_1', this, 1)">
                            ...
                            <div class="task-content">
                                <h4>参考動画の視聴と実習</h4>
                                <p>動画を見ながら、Canvaの基本操作とAI機能を実際に手を動かして試す。</p>
                            </div>
                        </li>
                        <li class="task-item" onclick="toggleTask('t1_2', this, 1)">
                            ...
                            <div class="task-content">
                                <h4>SNS投稿画像を1枚作成</h4>
                                <p>テンプレートを活用してInstagram等の画像を1枚作成する。</p>
                                <a href="https://www.canva.com/" target="_blank" class="btn btn-sm" onclick="event.stopPropagation();"><i class="fa-solid fa-arrow-up-right-from-square"></i> Canvaを開く</a>
                            </div>
                        </li>
                        <li class="task-item" onclick="toggleTask('t1_3', this, 1)">
                            ...
                            <div class="task-content">
                                <h4>AI画像生成テスト</h4>
                                <p>Canvaの「マジック生成」で好きなプロンプトを入力し、画像を生成する。</p>
                            </div>
                        </li>
                        <li class="task-item" onclick="toggleTask('t1_4', this, 1)">
                            ...
                            <div class="task-content">
                                <h4>デザインの保存</h4>
                                <p>作ったデザインのファイル名に自分の名前をつけて保存・提出する。</p>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div id="tab-second" class="tab-content">
            <div class="glass-card" style="border-top: 5px solid #8b5cf6;">
                <div class="card-header"><i class="fa-brands fa-youtube" style="color:#8b5cf6; background:#f5f3ff;"></i><h2>後半：動画解説（Affinity ＆ Nano Banana）</h2></div>
                <p style="font-size:1.1rem; margin-bottom:1.5rem;">Canvaのファミリーとなったプロ向けツール「Affinity」の紹介と、無料AI「Nano Banana」によるプロンプト編集テクニックを学びます。</p>
                
                <div class="video-grid">
                    <a href="https://youtu.be/ThbMYDqI0VY" target="_blank" class="video-thumb">
                        <img src="https://img.youtube.com/vi/ThbMYDqI0VY/maxresdefault.jpg" alt="動画3" onerror="this.src='https://img.youtube.com/vi/ThbMYDqI0VY/hqdefault.jpg'">
                        <div class="play-overlay"><i class="fa-solid fa-play"></i></div>
                    </a>
                    <a href="https://youtu.be/JiUFPy97nEU" target="_blank" class="video-thumb">
                        <img src="https://img.youtube.com/vi/JiUFPy97nEU/maxresdefault.jpg" alt="動画4" onerror="this.src='https://img.youtube.com/vi/JiUFPy97nEU/hqdefault.jpg'">
                        <div class="play-overlay"><i class="fa-solid fa-play"></i></div>
                    </a>
                </div>

                <div class="info-box" style="border-left-color: #8b5cf6; background: #f5f3ff;">
                    <h4 style="color:#6d28d9;"><i class="fa-solid fa-wand-magic-sparkles"></i> プロンプトによる画像編集・加工</h4>
                    <p style="color:#4c1d95;">ゼロから画像を生成するだけでなく、すでに存在している写真の「背景だけを変える」「いらない看板だけを消す」など、部分的なプロンプト補正技術も習得しましょう。</p>
                </div>
            </div>
            ...
            <div class="glass-card">
                ...
                <p style="font-size:1.1rem;">画像生成のコツを自分のものにするために、プロンプトの一覧をノートにまとめます。</p>
                ...
                <div class="mission-area" id="mission-group-2">
                    ...
                    <div class="mission-header">
                        <h3><i class="fa-solid fa-book-open-reader"></i> MILESTONE 2: プロンプト武具庫</h3>
                    ...
                    <ul class="task-list">
                        <li class="task-item" onclick="toggleTask('t2_1', this, 2)">
                            ...
                            <div class="task-content">
                                <h4>Nano Banana用プロンプトまとめ</h4>
                                <p>専用シートから気に入ったプロンプトをピックアップし、自分のドキュメントに保存する。</p>
                                <a href="https://docs.google.com/spreadsheets/d/1bRG2ciyDl2DHQLjIY4k8bJrUzuvD0orX1UFA0yqY1xU/edit?usp=sharing" target="_blank" class="btn btn-sm btn-outline" onclick="event.stopPropagation();"><i class="fa-solid fa-table"></i> プロンプト一覧表を開く</a>
                            </div>
                        </li>
                        <li class="task-item" onclick="toggleTask('t2_2', this, 2)">
                            <div class="custom-checkbox" id="check_t2_2"><i class="fa-solid fa-check"></i></div>
                            <div class="task-content">
                                <h4>画像素材のダウンロードと加工</h4>
                                <p>加工用の画像素材をダウンロードし、Nano Bananaなどで背景変更や不要物消去などを試す。</p>
                                <a href="https://drive.google.com/drive/folders/1lcq-8fEZLzjv0fs9EdYg3AuKvm_aGQF3?usp=sharing" target="_blank" class="btn btn-sm" onclick="event.stopPropagation();"><i class="fa-brands fa-google-drive"></i> 素材フォルダを開く</a>
                            </div>
                        </li>
                        <li class="task-item" onclick="toggleTask('t2_3', this, 2)">
                            <div class="custom-checkbox" id="check_t2_3"><i class="fa-solid fa-check"></i></div>
                            <div class="task-content">
                                <h4>【発展】追加ツールを触ってみる</h4>
                                <p>時間が余った場合は、AffinityやAIEASEといった特化型ツールにも少しだけ触れておく。</p>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', () => {
            const saved = localStorage.getItem('day2_premium_prog');
            if (saved) {
        ...
        function toggleTask(taskId, element, groupId) {
            ...
            state[taskId] = done;
            localStorage.setItem('day2_premium_prog', JSON.stringify(state));
...
with open("vol02-1_canva_basics.html", "w", encoding="utf-8") as f:
    f.write(html_content)

print("Generated vol02-1_canva_basics.html completely.")
